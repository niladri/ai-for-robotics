...
R =  matrix([[0.00001, 0.0], [0.0, 0.00001]])
# measurement uncertainty: use 2x2 matrix with 0.0 as main diagonal due to no uncertainty
...
def demo_grading(estimate_next_pos_fcn, target_bot, OTHER = None):
    ...
    while not localized and ctr <= 10: 
        ...
        print(true_position, position_guess)
